        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculatedRateValue = table.Column<int>(type: "int", nullable: false),
                    TotalRatedPeople = table.Column<int>(type: "int", nullable: false),
                    SoldNumber = table.Column<int>(type: "int", nullable: false),
                    SizeTypeId = table.Column<int>(type: "int", nullable: true),
                    AvailableNumber = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RateItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
